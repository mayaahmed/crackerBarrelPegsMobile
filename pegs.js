...
status=0;  row1=0; row2=0; col1=0; col2=0; count=14;

function initial(){
  var pic;
pic = document.getElementById('marblePic11'); 
...
pic3 = document.getElementById('marblePic'+row3+col3); 
pic3.style.visibility="hidden";
     count=count-1;
var moveObj= {r1: row1, r2: row2, r3: row3, c1: col1, c2: col2, c3: col3};
movesArray.push(moveObj);
length = movesArray.length-1;
